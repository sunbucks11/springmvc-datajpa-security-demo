package com.java.blog.entity.spa;
...
@NamedQueries({
        @NamedQuery(
                name = UserTest.FIND_BY_USERNAME,
                query = "select u from UserTest u where username = :username"
        ),
        @NamedQuery(
                name = UserTest.COUNT_TODAYS_CALORIES,
...
public class UserTest extends AbstractEntity {
    ...
    public UserTest(String username, String passwordDigest, String email, Long maxCaloriesPerDay) {
